...
var GetLikedMediaForUserInputSet = function() {
    GetLikedMediaForUserInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the UserID input for this Choreo. ((optional, integer) The ID of the user that you want to retrieve. Defaults to 'self' which will return the user associated with the access token.)
        */
...
var UserFollowsInputSet = function() {
    UserFollowsInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the UserID input for this Choreo. ((required, integer) The ID of the user that you want to retrieve. Defaults to 'self' which will return the user associated with the access token.)
        */
        this.set_UserID = function(value) {
            this.setInput("UserID", value);
        }
