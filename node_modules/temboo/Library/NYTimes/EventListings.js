...
var SearchEvents = function(session) {
	...
	*/
    var location = "/Library/NYTimes/EventListings/SearchEvents"
...
var SearchEventsByBoundedBox = function(session) {
    /*
        Create a new instance of the SearchEventsByBoundedBox Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/NYTimes/EventListings/SearchEventsByBoundedBox"
    SearchEventsByBoundedBox.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new SearchEventsByBoundedBoxResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new SearchEventsByBoundedBoxInputSet();
    }
...
var SearchEventsByBoundedBoxInputSet = function() {
    SearchEventsByBoundedBoxInputSet.super_.call(this);
        /*
        Set the value of the APIKey input for this Choreo. ((required, string) The API Key provided by NY Times.)
        */
        this.set_APIKey = function(value) {
...
var SearchEventsByBoundedBoxResultSet = function(resultStream) {
    SearchEventsByBoundedBoxResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from the NY Times API. Format corresponds to the ResponseFormat input. Defaults to xml.)
        */
        this.get_Response = function() {
...
util.inherits(SearchEventsByBoundedBox, choreography.Choreography);
util.inherits(SearchEventsByBoundedBoxInputSet, choreography.InputSet);
util.inherits(SearchEventsByBoundedBoxResultSet, choreography.ResultSet);
exports.SearchEventsByBoundedBox = SearchEventsByBoundedBox;
