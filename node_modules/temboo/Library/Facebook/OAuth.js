...
var FinalizeOAuthResultSet = function(resultStream) {
    FinalizeOAuthResultSet.super_.call(this, resultStream);    
        ...
        */
        ...
        /*
        Retrieve the value for the "ErrorMessage" output from this Choreo execution. ((string) If an error occurs during the redirect process, this output variable will contain the error message generated by Foursquare.)
        */
