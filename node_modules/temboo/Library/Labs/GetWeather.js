...
var ByAddressInputSet = function() {
    ByAddressInputSet.super_.call(this);
        /*
        Set the value of the APICredentials input for this Choreo. ((required, json) A JSON dictionary containing a Yahoo App ID. See Choreo documentation for formatting examples.)
        */
...
var ByAddressResultSet = function(resultStream) {
    ByAddressResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((json) Contains combined weather data from Yahoo Weather, NOAA, and EnviroFacts.)
        */
...
var ByGoogleLat = function(session) {
    /*
        Create a new instance of the ByGoogleLat Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Labs/GetWeather/ByGoogleLat"
    ByGoogleLat.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new ByGoogleLatResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new ByGoogleLatInputSet();
    }
...
var ByGoogleLatInputSet = function() {
    ByGoogleLatInputSet.super_.call(this);
        /*
...
var ByGoogleLatResultSet = function(resultStream) {
    ByGoogleLatResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((json) Contains weather information based on the coordinates returned from the Foursquare checkin.)
        */
        this.get_Response = function() {
...
util.inherits(ByGoogleLat, choreography.Choreography);
util.inherits(ByGoogleLatInputSet, choreography.InputSet);
util.inherits(ByGoogleLatResultSet, choreography.ResultSet);
exports.ByGoogleLat = ByGoogleLat;
