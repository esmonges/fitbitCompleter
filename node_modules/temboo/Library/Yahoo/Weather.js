...
var GetWeatherInputSet = function() {
    GetWeatherInputSet.super_.call(this);
        /*
        Set the value of the Units input for this Choreo. ((optional, string) The unit of temperature in the response. Acceptable inputs: f for Fahrenheit or c for Celcius. Defaults to f. When c is specified, all units measurements returned are changed to metric.)
        */
...
var GetWeatherByAddressInputSet = function() {
    GetWeatherByAddressInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the AppID input for this Choreo. ((required, string) The App ID provided by Yahoo!)
        */
...
var GetWeatherByAddressResultSet = function(resultStream) {
    GetWeatherByAddressResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "AddressFile" output from this Choreo execution. (The address file returned by Yahoo! GeoCode.)
        */
        this.get_AddressFile = function() {
            return this.getResult("AddressFile");
        }
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Yahoo Weather.)
        */
        ...
        /*
        Retrieve the value for the "WOEID" output from this Choreo execution. ((integer) The unigue Where On Earth ID of the location.)
        */
...
var GetWeatherByCoordinatesInputSet = function() {
    GetWeatherByCoordinatesInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the Lattitude input for this Choreo. ((required, decimal) The lattitude coordinate of the location you want to search.)
        */
...
var GetWeatherByCoordinatesResultSet = function(resultStream) {
    GetWeatherByCoordinatesResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Address" output from this Choreo execution. (The address of the location corresponding to the coordinates.)
        */
        this.get_Address = function() {
            return this.getResult("Address");
        }
        /*
        Retrieve the value for the "Response" output from this Choreo execution. (The response from Yahoo Weather.)
        */
