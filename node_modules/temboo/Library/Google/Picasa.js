...
var AddCommentToPhotoInputSet = function() {
    AddCommentToPhotoInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ClientID input for this Choreo. ((required, string) The client id provided by Google.)
        */
        ...
        /*
        Set the value of the ClientSecret input for this Choreo. ((required, string) The client secret provided by Google.)
        */
...
var ListPhotosByAlbumInputSet = function() {
    ListPhotosByAlbumInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the ClientID input for this Choreo. ((required, string) The client id provided by Google Pacasa when you sign up for an account.)
        */
        this.set_ClientID = function(value) {
            this.setInput("ClientID", value);
        }
