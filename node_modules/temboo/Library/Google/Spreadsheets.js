...
var CellRangeQuery = function(session) {
    /*
        Create a new instance of the CellRangeQuery Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Google/Spreadsheets/CellRangeQuery"
    CellRangeQuery.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new CellRangeQueryResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new CellRangeQueryInputSet();
    }
...
var CellRangeQueryInputSet = function() {
    CellRangeQueryInputSet.super_.call(this);
        /*
...
var CellRangeQueryResultSet = function(resultStream) {
    CellRangeQueryResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((xml) The response from Google)
        */
        this.get_Response = function() {
...
util.inherits(CellRangeQuery, choreography.Choreography);
util.inherits(CellRangeQueryInputSet, choreography.InputSet);
util.inherits(CellRangeQueryResultSet, choreography.ResultSet);
exports.CellRangeQuery = CellRangeQuery;
