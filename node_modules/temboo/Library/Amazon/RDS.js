...
var CreateDBInstanceInputSet = function() {
    CreateDBInstanceInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the AllocatedStorage input for this Choreo. ((required, integer) Storage amount (in gigabytes) to be configured for the DB. Use 5 to 1024 for MySQL or 10 to 1024 for Oracle.)
        */
        ...
        */
        ...
        /*
        Set the value of the DBName input for this Choreo. ((required, string) For MySQL, this is the name of the db that is created on the instance. For Oracle, it refers to the SID.)
        */
        ...
        /*
        Set the value of the Engine input for this Choreo. ((required, string) The name of the database engine to use for the instance. Options are: MySQL, oracle-se1, oracle-se, and oracle-ee.)
        */
