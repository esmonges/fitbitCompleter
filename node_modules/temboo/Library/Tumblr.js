...
var CreateChatPost = function(session) {
	...
	*/
    var location = "/Library/Tumblr/CreateChatPost"
...
var CreateChatPostInputSet = function() {
    CreateChatPostInputSet.super_.call(this);
        /*
        Set the value of the Conversation input for this Choreo. ((required, string) The text of the conversation/chat, with dialogue labels (no HTML).)
        */
...
var CreateLinkPost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/CreateLinkPost"
...
var CreatePhotoPostWithImageFile = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/CreatePhotoPostWithImageFile"
...
var CreatePhotoPostWithImageFileInputSet = function() {
    CreatePhotoPostWithImageFileInputSet.super_.call(this);
        /*
        Set the value of the Data input for this Choreo. ((conditional, string) The base64 ecoded contents of the image you want to post.)
        */
...
var CreatePhotoPostWithURL = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/CreatePhotoPostWithURL"
...
var CreateQuotePost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/CreateQuotePost"
...
var CreateQuotePostInputSet = function() {
    CreateQuotePostInputSet.super_.call(this);
        /*
        Set the value of the Quote input for this Choreo. ((required, string) The full text of the quote. HTML entities must be escaped.)
        */
...
var CreateTextPost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/CreateTextPost"
...
var DeletePost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/DeletePost"
...
var EditChatPost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditChatPost"
...
var EditLinkPost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditLinkPost"
...
var EditPhotoPostWithImageFile = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditPhotoPostWithImageFile"
...
var EditPhotoPostWithURL = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditPhotoPostWithURL"
...
var EditQuotePost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditQuotePost"
...
var EditTextPost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/EditTextPost"
...
var GetUserInformation = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/GetUserInformation"
...
var LikePost = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/LikePost"
...
var RetrieveBlogFollowers = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveBlogFollowers"
...
var RetrieveBlogInfo = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveBlogInfo"
...
var RetrieveDraftPosts = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveDraftPosts"
...
var RetrieveFollowedBlogsForUser = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveFollowedBlogsForUser"
...
var RetrievePublishedPosts = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrievePublishedPosts"
...
var RetrieveQueuedPosts = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveQueuedPosts"
...
var RetrieveSubmissionPosts = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveSubmissionPosts"
...
var RetrieveUserDashboard = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveUserDashboard"
...
var RetrieveUserLikes = function(session) {
    /*
        ...
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/Tumblr/RetrieveUserLikes"
