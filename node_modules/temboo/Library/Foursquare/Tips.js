...
var AddTipsResultSet = function(resultStream) {
    ...
    */
    this.getTipDetails = function()  {
    	return new  FoursquareTipDetails(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["tip"]);
    }
}
...
var DoneResultSet = function(resultStream) {
    ...
    */
    this.getDone = function()  {
    	return new  FoursquareDone(JSON.parse(this.getResult('Response'))["done"]);
    }
    /*
    Get the response status code
    */
...
var SearchNearbyTipsResultSet = function(resultStream) {
    ...
    */
    this.getTips = function()  {
    	var listEntries = getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["tips"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareTipDetails(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
