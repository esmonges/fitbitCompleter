...
var AddItemResultSet = function(resultStream) {
    ...
    */
    this.getItem = function()  {
    	return new  FoursquareItem(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["item"]);
    }
}
...
var ListFollowersResultSet = function(resultStream) {
    ...
    */
    this.getListFollowers = function()  {
    	var listEntries = getSubArrayByKey(JSON.parse(this.getResult('Response')), "response")["followers"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareListFollower(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
