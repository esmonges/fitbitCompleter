...
var SearchSpecialsResultSet = function(resultStream) {
    ...
    */
    this.getSpecialsList = function()  {
    	var listEntries = getSubArrayByKey(getSubArrayByKey(JSON.parse(this.getResult('Response')), "response"), "specials")["items"];
    	var resultArray = new Array();
    	if(listEntries != null) {
    		for(var i=0; i < listEntries.length; i++) {
    			resultArray[i] = new  FoursquareSpecialsList(listEntries[i]);
    		}
    	}
    	return resultArray;
    }
