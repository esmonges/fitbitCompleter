...
var WeatherByCenterPointSubgridSummarizedInputSet = function() {
    WeatherByCenterPointSubgridSummarizedInputSet.super_.call(this);
        ...
        */
        ...
        /*
        Set the value of the StartDate input for this Choreo. ((optional, date) Enter the start time for retrieval of NDWD data in following format: 2004-04-27 If null, the earliest date in the database is returned.)
        */
...
var WeatherByCitiesSummarized = function(session) {
    /*
        Create a new instance of the WeatherByCitiesSummarized Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/NOAA/WeatherByCitiesSummarized"
    WeatherByCitiesSummarized.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new WeatherByCitiesSummarizedResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new WeatherByCitiesSummarizedInputSet();
    }
...
var WeatherByCitiesSummarizedInputSet = function() {
    WeatherByCitiesSummarizedInputSet.super_.call(this);
        /*
...
var WeatherByCitiesSummarizedResultSet = function(resultStream) {
    WeatherByCitiesSummarizedResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((xml) Response from NDFD servers.)
        */
        this.get_Response = function() {
...
util.inherits(WeatherByCitiesSummarized, choreography.Choreography);
util.inherits(WeatherByCitiesSummarizedInputSet, choreography.InputSet);
util.inherits(WeatherByCitiesSummarizedResultSet, choreography.ResultSet);
exports.WeatherByCitiesSummarized = WeatherByCitiesSummarized;
...
var WeatherByCitiesUnsummarized = function(session) {
    /*
        Create a new instance of the WeatherByCitiesUnsummarized Choreo. A TembooSession object, containing a valid
        set of Temboo credentials, must be supplied.
	*/
    var location = "/Library/NOAA/WeatherByCitiesUnsummarized"
    WeatherByCitiesUnsummarized.super_.call(this, session, location);

    /*
    Define a callback that will be used to appropriately format the results of this Choreo.
    */
    var newResultSet = function(resultStream) {
        return new WeatherByCitiesUnsummarizedResultSet(resultStream);
    }
	...
	*/
    this.newInputSet = function() {
        return new WeatherByCitiesUnsummarizedInputSet();
    }
...
var WeatherByCitiesUnsummarizedInputSet = function() {
    WeatherByCitiesUnsummarizedInputSet.super_.call(this);
        /*
        Set the value of the CitiesLevel input for this Choreo. ((required, integer) Enter a city grouping number. For example: enter 1, to obtain weather information for primary U.S. cities. See documentation for additional numbers.)
        */
        this.set_CitiesLevel = function(value) {
...
var WeatherByCitiesUnsummarizedResultSet = function(resultStream) {
    WeatherByCitiesUnsummarizedResultSet.super_.call(this, resultStream);    
        /*
        Retrieve the value for the "Response" output from this Choreo execution. ((xml) Response from NDFD servers.)
        */
        this.get_Response = function() {
...
util.inherits(WeatherByCitiesUnsummarized, choreography.Choreography);
util.inherits(WeatherByCitiesUnsummarizedInputSet, choreography.InputSet);
util.inherits(WeatherByCitiesUnsummarizedResultSet, choreography.ResultSet);
exports.WeatherByCitiesUnsummarized = WeatherByCitiesUnsummarized;
